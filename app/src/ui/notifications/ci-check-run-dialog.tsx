...
import { CICheckRunListItem } from '../branches/ci-check-list-item'

interface ICICheckRunDialogProps {
...
interface ICICheckRunDialogState {
...
/** The CI Check list. */
export class CICheckRunDialog extends React.PureComponent<
  ICICheckRunDialogProps,
  ICICheckRunDialogState
> {
  private statusSubscription: IDisposable | null = null

  public constructor(props: ICICheckRunDialogProps) {
    super(props)
  ...
  public componentDidUpdate(prevProps: ICICheckRunDialogProps) {
  ...
  public render() {
    ...
    return (
      <div className="ci-check-run-dialog">
        <div className="ci-check-run-dialog-list">
        ...
        <div className="ci-check-run-dialog-detail">Hello world</div>
      </div>
    )
  }
}
